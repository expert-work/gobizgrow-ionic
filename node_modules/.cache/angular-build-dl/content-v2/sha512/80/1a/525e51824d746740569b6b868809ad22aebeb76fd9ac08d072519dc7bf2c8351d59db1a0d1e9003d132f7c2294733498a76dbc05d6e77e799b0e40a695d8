    ...
    var DealsService = /*#__PURE__*/function () {
      ...
      _createClass(DealsService, [{
        ...
        value: function getListingDataSource() {
          ...
          return this.http.get('./assets/sample-data/deals/listing.json').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (data) {
            ...
            var itemsWithRelativeDates = items.map(function (dealItem, index) {
              ...
              return Object.assign(Object.assign({}, dealItem), {
                expirationDate: _this3.relativeDates[index]
              });
        ...
        value: function getDetailsDataSource() {
          return this.http.get('./assets/sample-data/deals/details.json').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (data) {
  ...
  function srcAppDealsDetailsDealsDetailsModelTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var DealsDetailsModel = /*#__PURE__*/function (_shell_data_store__WE) {
      ...
      function DealsDetailsModel() {
        ...
        _this4.showcaseImages = ['', '', '']; // Default mock value
        // expirationDate = '03/03/2019';

        _this4.expirationDate = dayjs__WEBPACK_IMPORTED_MODULE_0__().add(5, 'day').format('MM/DD/YYYY HH:mm:ss');
        _this4.relatedDeals = [{
          logo: '',
          name: '',
          description: ''
  ...
  function srcAppDealsListingDealsListingModelTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var DealsListingModel = /*#__PURE__*/function (_shell_data_store__WE2) {
      ...
      function DealsListingModel() {
        ...
        _this5.items = [new DealsItemModel(), new DealsItemModel(), new DealsItemModel(), new DealsItemModel()];
        return _this5;
      }
...
//# sourceMappingURL=default~deals-details-deals-details-module-ngfactory~deals-listing-deals-listing-module-ngfactory-es5.js.map