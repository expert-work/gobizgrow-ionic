        ...
        value: function saveForm() {
          ...
          this.apisService.itemAdd(form).subscribe(function (result) {
            ...
            if (error.status == 401) {
              ...
              _this6.toastService.presentToast(error.error.data);
            }
          });
        }
      }, {
              ...
              while (1) {
                switch (_context2.prev = _context2.next) {
                  ...
                  case 2:
                    ...
                    modal.onDidDismiss().then(function (data) {
                      if (_this7.apisService.isDefined(data.data[0])) {
                        _this7.categories = data.data;
                        _this7.categories = _this7.apisService.sortArray(_this7.categories);
                      }
                    });
                    _context2.next = 6;
                    return modal.present();
...
//# sourceMappingURL=default~estimates-new-new-module-ngfactory~invoices-new-new-module-ngfactory~items-list-list-module-~df28b05a-es5.js.map