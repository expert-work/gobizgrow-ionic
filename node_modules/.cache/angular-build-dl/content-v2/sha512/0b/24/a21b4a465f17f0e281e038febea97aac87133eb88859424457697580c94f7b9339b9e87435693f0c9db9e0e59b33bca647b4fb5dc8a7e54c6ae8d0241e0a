                  ...
                  case 0:
                    buttons = [{
                      ...
                      handler: function handler() {
                        _this7.addImage(_capacitor_core__WEBPACK_IMPORTED_MODULE_4__["CameraSource"].Camera);
                      }
                    }, {
                      text: 'Choose From Photos Photo',
                      icon: 'image',
                      handler: function handler() {
                        _this7.addImage(_capacitor_core__WEBPACK_IMPORTED_MODULE_4__["CameraSource"].Photos);
                      }
                    ...
                    if (!this.platform.is('hybrid')) {
                      buttons.push({
                        ...
                        icon: 'attach',
                        handler: function handler() {
                          _this7.fileInput.nativeElement.click();
                        }
                      });
                    }
                  ...
                  case 2:
                    ...
                    this.apisService.uploadImage(blobData, imageName, image.format, this.displayUserData.auth_token).subscribe(function (newImage) {
                      ...
                      if (!newImage.isError) {
                        ...
                        _this8.modalController.dismiss(newImage.data);
                      } else {
                        _this8.toastService.presentToast('Somthing went wrong');
                      }
                    });
        ...
        value: function uploadFile(event) {
          ...
          this.apisService.uploadImageFile(file, this.displayUserData.auth_token).subscribe(function (newImage) {
            ...
            if (!newImage.isError) {
              ...
              _this9.modalController.dismiss(newImage.data);
            } else {
              _this9.toastService.presentToast('Somthing went wrong');
            }
          });
        }
      }, {
...
//# sourceMappingURL=default~estimates-new-new-module-ngfactory~invoices-new-new-module-ngfactory~jobs-new-new-module-ngf~2b2d7ec6-es5.js.map