...
const ɵ0 = () => __webpack_require__.e(/*! import() | tabs-tabs-module-ngfactory */ "tabs-tabs-module-ngfactory").then(__webpack_require__.bind(null, /*! ./../tabs/tabs.module.ngfactory */ "./src/app/tabs/tabs.module.ngfactory.js")).then(m => m.TabsPageModuleNgFactory);
const routes = [
    {
        path: '',
