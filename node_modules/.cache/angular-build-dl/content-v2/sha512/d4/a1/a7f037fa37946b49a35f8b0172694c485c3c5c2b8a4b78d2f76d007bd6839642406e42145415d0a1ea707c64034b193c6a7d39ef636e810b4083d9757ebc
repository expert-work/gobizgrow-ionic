...
/* harmony import */ var _list_page__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./list.page */ "./src/app/estimates/list/list.page.ts");
...
class ListPage {
    constructor(actionSheetController, apisService, toastService, authService, router, route) {
    ...
    newInvoice() {
        ...
        this.loading = true;
        this.apisService.nextEstimate(form).subscribe((result) => {
            this.loading = false;
            if (result.data) {
    ...
    addMoreItems() {
        ...
        form.append('auth_token', this.displayUserData.auth_token);
        this.apisService.estimates(form).subscribe((result) => {
