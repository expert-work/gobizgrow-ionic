...
/* harmony import */ var _edit_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./edit.page */ "./src/app/items/edit/edit.page.ts");
...
class EditPage {
    constructor(router, menu, authService, apisService, storageService, toastService, navParams, modalController) {
        ...
        this.form = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormGroup"]({
            ...
            'price': new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](this.data.price, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].compose([
                _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required,
    ...
    saveForm() {
        ...
        this.apisService.itemUpdate(form).subscribe((result) => {
            this.desabled = false;
